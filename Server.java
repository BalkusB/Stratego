...
public class Server extends JFrame implements ActionListener, MouseListener, Runnable
{
	...
	private JLabel connectionOpened;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			pan.remove(connectButton);
			connectionOpened = new JLabel("Connection Opened");
			connectionOpened.setBounds(300, 300, 300, 80);
			connectionOpened.setFont(new Font("",Font.PLAIN, 30));
			pan.add(connectionOpened);
